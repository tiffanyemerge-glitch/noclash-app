...
async function sendAmbassadorApproved({ to, name, code }) {
  return sendViaResend({
    ...
    text: `Hi ${name},\n\nYou're in! Your NoClash referral code is: ${code}\n\nAs a thank-you, you've also got a free Organizer Pass (normally $49) on us — if you already have a NoClash organizer account under this email, it's active now; if not, it'll activate automatically the moment you sign up as an organizer with this email.\n\nShare your code with your audience, or send people to noclashcalendar.com/signup?ref=${code} — anyone who signs up with your code and buys an Organizer Pass ($49) earns you a 15% commission ($7.35).\n\nTo stay active in the program, post about NoClash at least twice a month.\n\nThanks for helping spread the word!`
  });
}

async function sendOrganizerPassInvite({ to }) {
  return sendViaResend({
    to,
    subject: "You've got a free Organizer Pass on NoClash",
    text: `Hi,\n\nYou've been set up with a free Organizer Pass on NoClash (normally $49) — it never expires, no charge, ever.\n\nTo activate it, create an organizer account using this same email address: noclashcalendar.com/signup\n\nThe moment you sign up as an Organizer with ${to}, your pass activates automatically and you can post your first event right away.\n\nQuestions? Just reply to this email.`
  });
}
